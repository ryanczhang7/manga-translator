...
-- The ledger. `page_id` deliberately carries no `ON DELETE` action: a bill that
-- disappears when its page row does would make the ledger unauditable, and §4
-- says append-only. Token counts as well as dollars, because rates change and a
